        ...
        <div class="main_box">
            ...
            <div class="pubber_box">
                ...
                <div class="pub_img">
                    ...
                    <button class="btn btn-primary btn-large add_img">+添加图片</button>

                    <div class="ctr_wrap clearfix" style="display: none;">
                        <select name="pub_range" id="" class="pub_option">
                            <option value="">所有人可见</option>
                            <option value="">仅自己可见</option>
                        </select>
                ...
                <div class="pub_video">
                    ...
                    <div class="pub_title">请填入视频连接:</div>
                    <input type="text" class="add_video_input" /><button class="btn btn-primary add_video">添加链接</button>
